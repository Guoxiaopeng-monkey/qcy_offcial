    ...
    fetch(`${routes.cart_change_url}`, { ...fetchConfig(), ...{ body } })
      ...
      .then((state) => {
        ...
        fetch(`${routes.cart_url}?section_id=main-cart-footer`)
          ...
          .then((responseText) => {
            const html = new DOMParser().parseFromString(responseText, 'text/html');
            const sourceQty = html.querySelector('.component-side-cart-details');
            
            if (sourceQty) {
              const targetElement = document.querySelector('.component-side-cart-details');
              if (targetElement) {
